...
export const Sidebar = ({ onAlmacenClick, onProduckClick, onHomeClick, onClientClick,onOrderClick }) => {
            ...
            <div className="row">
                <div className="col vh-100 d-flex align-items-start flex-column sidebar-column">
                    ...
                    <div className="Sidebar-body mb-auto mt-4 p-2">
                        ...
                        <div className="Sidebar-options fs-6" onClick={onOrderClick}><button type="button" className="Sidebar-button"><i className="fa-solid fa-file-circle-plus"></i><span className="m-3">Orden de Compra</span></button></div>
                    </div>
